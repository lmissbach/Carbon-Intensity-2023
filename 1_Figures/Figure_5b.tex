\begin{figure}[ht!]
     \centering
    \caption{Partial dependence plot (SHAP) for 88 countries and ten clusters}
    \label{fig:5b}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
        \centering
         \caption{Partial dependence plot (SHAP) for Mexico (cluster A)}
         \label{fig:5b_MEX}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
   \centering
         \caption{Partial dependence plot (SHAP) for Bolivia (cluster B)}
         \label{fig:5b_BOL}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \end{subfigure}
    ...
    \begin{subfigure}[b]{\textwidth}  
   \centering
         \caption{Partial dependence plot (SHAP) for Peru (cluster B)}
         \label{fig:5b_PER}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}        
    \centering
         \caption{Partial dependence plot (SHAP) for El Salvador (cluster B)}
         \label{fig:5b_SLV}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
   \centering
         \caption{Partial dependence plot (SHAP) for Ecuador (cluster C)}
         \label{fig:5b_ECU}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
   \centering
         \caption{Partial dependence plot (SHAP) for Uruguay (cluster C)}
         \label{fig:5b_URY}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \centering
    ...
    \begin{subfigure}[b]{\textwidth}
         \centering
         \caption{Partial dependence plot (SHAP) for Argentina (cluster D)}
         \label{fig:5b_ARG}
   ...
   \begin{subfigure}[b]{\textwidth}
         \centering
         \caption{Partial dependence plot (SHAP) for Australia (cluster D)}
         \label{fig:5b_AUS}
         \includegraphics[width=\textwidth]{Figure 5b/Figure_5b_AUS}    
         \end{subfigure}
    \\
    \vspace{0.5cm}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
   \centering
         \caption{Partial dependence plot (SHAP) for Israel (cluster D)}
         \label{fig:5b_ISR}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
         \centering
         \caption{Partial dependence plot (SHAP) for Germany (cluster E)}
         \label{fig:5b_DEU}
    ...
    \begin{subfigure}[b]{\textwidth}
         \centering
         \caption{Partial dependence plot (SHAP) for France (cluster E)}
         \label{fig:5b_FRA}
   ...
   \begin{subfigure}[b]{\textwidth}
         \centering
         \caption{Partial dependence plot (SHAP) for United Kingdom (cluster E)}
         \label{fig:5b_GBR}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
         \centering
         \caption{Partial dependence plot (SHAP) for Romania (cluster E)}
         \label{fig:5b_ROU}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
   \centering
         \caption{Partial dependence plot (SHAP) for Mali (cluster F)}
         \label{fig:5b_MLI}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth} 
   \centering
         \caption{Partial dependence plot (SHAP) for Niger (cluster F)}
         \label{fig:5b_NER}
   ...
   \begin{subfigure}[b]{\textwidth}
    \centering
         \caption{Partial dependence plot (SHAP) for Latvia (cluster G)}
         \label{fig:5b_LVA}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
    \centering
         \caption{Partial dependence plot (SHAP) for Maldives (cluster G)}
         \label{fig:5b_MDV}
    ...
    \begin{subfigure}[b]{\textwidth}
   \centering
         \caption{Partial dependence plot (SHAP) for Mongolia (cluster G)}
         \label{fig:5b_MNG}
   ...
   \begin{subfigure}[b]{\textwidth}
   \centering
         \caption{Partial dependence plot (SHAP) for Norway (cluster G)}
         \label{fig:5b_NOR}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}  
   \centering
         \caption{Partial dependence plot (SHAP) for Pakistan (cluster G)}
         \label{fig:5b_PAK}
    ...
    \begin{subfigure}[b]{\textwidth}
    \centering
         \caption{Partial dependence plot (SHAP) for Rwanda (cluster H)}
         \label{fig:5b_RWA}
   ...
   \begin{subfigure}[b]{\textwidth}
     \centering
         \caption{Partial dependence plot (SHAP) for Uganda (cluster H)}
         \label{fig:5b_UGA}
...
\begin{figure}[ht!]\ContinuedFloat
   ...
   \begin{subfigure}[b]{\textwidth}
    \centering
         \caption{Partial dependence plot (SHAP) for Nigeria (cluster I)}
         \label{fig:5b_NGA}
    ...
    \begin{subfigure}[b]{\textwidth}
    \centering
         \caption{Partial dependence plot (SHAP) for Senegal (cluster I)}
         \label{fig:5b_SEN}
   ...
   \begin{subfigure}[b]{\textwidth}
    \centering
         \caption{Partial dependence plot (SHAP) for the Philippines (cluster J)}
         \label{fig:5b_PHL}
...
\begin{figure}[ht!]\ContinuedFloat
    ...
    \begin{subfigure}[b]{\textwidth}
    \centering
         \caption{Partial dependence plot (SHAP) for Vietnam (cluster J)}
         \label{fig:5b_VNM}

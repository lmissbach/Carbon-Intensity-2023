...
\begin{response}
    \begin{itemize}
        ...
        \item What explains heterogeneity overall (including income - can we use income as an identifier)? Is it progressive or regressive? Theil index: Re-explains contribution of variation in income. Defensible or not. Should be used for visualization in any case. This is why we exclude it, as it would rate again the influence of expenditures on variation.
    \end{itemize}
\end{response}

...
We assume that governments are mostly concerned with the immediate effects of policies and public acceptance. We therefore ignore the intertemporal dimension and neglect households' dynamic responses to climate and compensation policies, which may alter additional costs and their distribution. We express the decision problem of the government as follows:  
...
Examining the household-level carbon intensity for different sectors \textit{s}, denoted $e_{i,s}$, allows for understanding heterogeneous impacts of different policies \textit{p}, for example of policies directed at the transport or electricity sector or of trade policies, such as carbon border adjustments.
...
\paragraph{Comparing vertical and horizontal distributional effects}

\paragraph{Comparing different climate policy instruments}

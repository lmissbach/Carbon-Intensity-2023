...
Analyzing heterogeneity in carbon intensity of consumption provides some indicators for the distributional impacts of climate policy at the country-level.
...
\item Important concern: Low predictive power, as identified for some countries, means that any transfer based on characteristics observable in our dataset will be ineffective to some extent! Key finding of this study, that in some countries cost burden is difficult to predict. Additional country- and policy-specific research needed.

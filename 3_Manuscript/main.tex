...
We proceed as follows: In Section \ref{sec:literature}, we develop a theoretical framework describing the distributional impacts of climate policy and their relevance for governments to design complementary compensation policies. In Section \ref{sec:data_methods}, we describe our modeling approach and analytical methods. In Section \ref{sec:results}, we analyze the vertical and horizontal distributional effects of climate policy, present the relative importance of household characteristics for predicting carbon intensity at the country level, and cluster countries when household characteristics are similarly important. Finally, we discuss our findings in light of ongoing debates about how to avoid or address unintended distributional impacts of climate policy in Section \ref{sec:discussion} before concluding in Chapter \ref{sec:conclusion}.  

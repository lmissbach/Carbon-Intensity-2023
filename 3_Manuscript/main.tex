...
We present a theoretical framework that incorporates the decision problem of a government in face of heterogeneous impacts of climate policy on households. We integrate several aspects from research about the distributional implications of climate policy in our framework to motivate the core research questions of interest, but keep it sufficiently sparse. Similar approaches in political economy research study the role of heterogeneous interest groups for governments to enact climate policies \autocite{Aidt.1998}. We depart from such work by accounting for the governments' possibility to ease additional costs and their unequal distributional through compensating policies \autocite{Lindbeck.1987}. Moreover, we assume governments to be interested in maximizing \textit{public} acceptance when confronted with the choice of climate and compensation policies. 
